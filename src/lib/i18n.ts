...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    appTagline: "Smart AI Agriculture Companion for Farmers",
    telemetry: {
      satelliteStatus: "FIELD SATELLITE: ACTIVE",
      locationText: "LOC: 15.4292° N, 75.6318° E (GADAG, KA)",
      mandiSync: "AGMARKNET / e-NAM: LIVE SYNC",
      credits: "CREDITS",
      live: "LIVE",
      commandCenter: "KrishiMitra Hub",
    },
    nav: {
      overview: "Home",
      dashboard: "My Farm",
      ...
      transparency: "Verified Data",
      admin: "Admin Desk",
      farmtalk: "Ask AI (FarmTalk)",
    ...
    sectors: {
      fieldTelemetry: "MY FARM & CROPS",
      mandisEconomics: "MARKET & SCHEMES",
      loyaltyRewards: "REWARDS & WALLET",
      governanceAi: "MORE OPTIONS",
      utilityHub: "SERVICES & COMMUNITY",
    },
    dashboard: {
  ...
  hi: {
    ...
    appTagline: "किसानों के लिए स्मार्ट एआई कृषि सहायक",
    telemetry: {
      satelliteStatus: "खेत उपग्रह: सक्रिय",
      locationText: "स्थान: 15.4292° N, 75.6318° E (गदग, कर्नाटक)",
      mandiSync: "एगमार्कनेट / ई-नाम: लाइव सिंक",
      credits: "क्रेडिट",
      live: "लाइव",
      commandCenter: "कृषि केंद्र",
    },
    nav: {
      overview: "होम",
      dashboard: "मेरा खेत",
      digitalTwin: "मेरा खेत",
      schemes: "सरकारी योजनाएं",
      market: "मंडी भाव",
      marketplace: "कृषि बाजार",
      credits: "क्रेडिट व पुरस्कार",
      transparency: "सत्यापित डेटा",
      admin: "प्रशासन डेस्क",
      farmtalk: "फार्मटॉक एआई",
      diseaseScanner: "रोग स्कैनर",
      soilHealth: "मृदा स्वास्थ्य",
      weather: "मौसम पूर्वानुमान",
      cropAdvisor: "मेरी फसल",
    ...
    sectors: {
      fieldTelemetry: "मेरा खेत और फसलें",
      mandisEconomics: "मंडी और योजनाएं",
      loyaltyRewards: "क्रेडिट व पुरस्कार",
      governanceAi: "अन्य विकल्प",
  ...
  kn: {
    ...
    appTagline: "ರೈತರಿಗಾಗಿ ಸ್ಮಾರ್ಟ್ ಕೃಷಿ ಎಐ ಸಹಾಯಕ",
    telemetry: {
      satelliteStatus: "ಜಮೀನಿನ ಉಪಗ್ರಹ: ಸಕ್ರಿಯ",
      locationText: "ಸ್ಥಳ: 15.4292° N, 75.6318° E (ಗದಗ, ಕರ್ನಾಟಕ)",
      mandiSync: "ಅಗ್ಮಾರ್ಕ್ನೆಟ್ / ಇ-ನಾಮ್: ಲೈವ್ ಸಿಂಕ್",
      credits: "ಕ್ರೆಡಿಟ್ಸ್",
      live: "ಲೈವ್",
      commandCenter: "ಕೃಷಿ ಕೇಂದ್ರ",
    },
    nav: {
      overview: "ಮುಖಪುಟ",
      dashboard: "ನನ್ನ ಜಮೀನು",
      digitalTwin: "ನನ್ನ ಜಮೀನು",
      schemes: "ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು",
      market: "ಮಾರುಕಟ್ಟೆ",
      marketplace: "ಕೃಷಿ ಮಾರುಕಟ್ಟೆ",
      credits: "ಕ್ರೆಡಿಟ್ಸ್ & ಬಹುಮಾನ",
      transparency: "ಪರಿಶೀಲಿಸಿದ ಡೇಟಾ",
      admin: "ಆಡಳಿತ ಡೆಸ್ಕ್",
      farmtalk: "ಫಾರ್ಮ್‌ಟಾಕ್ ಎಐ",
      diseaseScanner: "ರೋಗ ಪತ್ತೆ ಸ್ಕ್ಯಾನರ್",
      soilHealth: "ಮಣ್ಣಿನ ಆರೋಗ್ಯ",
      weather: "ಹವಾಮಾನ",
      cropAdvisor: "ನನ್ನ ಬೆಳೆ",
    ...
    sectors: {
      fieldTelemetry: "ನನ್ನ ಜಮೀನು ಮತ್ತು ಬೆಳೆಗಳು",
      mandisEconomics: "ಮಾರುಕಟ್ಟೆ ಮತ್ತು ಯೋಜನೆಗಳು",
      loyaltyRewards: "ಕ್ರೆಡಿಟ್ಸ್ & ಬಹುಮಾನಗಳು",
      governanceAi: "ಹೆಚ್ಚಿನ ಆಯ್ಕೆಗಳು",
  ...
  te: {
    ...
    appTagline: "రైతుల కోసం స్మార్ట్ AI వ్యవసాయ సహాయకుడు",
    telemetry: {
      satelliteStatus: "వ్యవసాయ ఉపగ్రహం: క్రియాశీలం",
      locationText: "ప్రాంతం: 15.4292° N, 75.6318° E (గదగ్, కర్ణాటక)",
      mandiSync: "అగ్మార్క్‌నెట్ / ఈ-నామ్: లైవ్ సింక్",
      credits: "క్రెడిట్స్",
      live: "లైవ్",
      commandCenter: "కృషి కేంద్రం",
    },
    nav: {
      overview: "హోమ్",
      dashboard: "నా పొలం",
      ...
      transparency: "ధృవీకరించబడిన డేటా",
      admin: "అడ్మిన్ డెస్క్",
      farmtalk: "ఫామ్‌టాక్ AI",
    ...
    sectors: {
      fieldTelemetry: "నా పొలం & పంటలు",
      mandisEconomics: "మార్కెట్ & పథకాలు",
      loyaltyRewards: "క్రెడిట్స్ & రివార్డులు",
      governanceAi: "మరిన్ని ఎంపికలు",
  ...
  ta: {
    ...
    appTagline: "விவசாயிகளுக்கான ஸ்மார்ட் AI விவசாய துணை",
    telemetry: {
      satelliteStatus: "பண்ணை செயற்கைக்கோள்: இயங்குகிறது",
      locationText: "இடம்: 15.4292° N, 75.6318° E (கதக், கர்நாடகா)",
      mandiSync: "அக்மார்க்நெட் / இ-நாம்: நேரடி ஒத்திசைவு",
      credits: "கிரெடிட்ஸ்",
      live: "நேரலை",
      commandCenter: "விவசாய மையம்",
    },
    nav: {
      overview: "முகப்பு",
      dashboard: "என் பண்ணை",
      digitalTwin: "என் பண்ணை",
      schemes: "அரசு திட்டங்கள்",
      market: "சந்தை",
      marketplace: "விவசாய சந்தை",
      credits: "கிரெடிட்ஸ் & பரிசுகள்",
      transparency: "சரிபார்க்கப்பட்ட தரவு",
      admin: "நிர்வாக மேசை",
      farmtalk: "ஃபார்ம்டாக் AI",
      diseaseScanner: "நோய் கண்டறியும் ஸ்கேனர்",
      soilHealth: "மண் வளம்",
      weather: "வானிலை",
      cropAdvisor: "என் பயிர்",
    ...
    sectors: {
      fieldTelemetry: "என் பண்ணை & பயிர்கள்",
      mandisEconomics: "சந்தை & திட்டங்கள்",
      loyaltyRewards: "கிரெடிட்ஸ் & நன்மைகள்",
      governanceAi: "கூடுதல் விருப்பங்கள்",
  ...
  mr: {
    appName: "कृषिमित्र AI",
    appTagline: "शेतकऱ्यांसाठी स्मार्ट AI कृषी मार्गदर्शक",
    telemetry: {
      satelliteStatus: "शेत उपग्रह: सक्रिय",
      locationText: "स्थान: 15.4292° N, 75.6318° E (गदग, कर्नाटक)",
      mandiSync: "अॅगमार्कनेट / ई-नाम: थेट सिंक",
      credits: "क्रेडिट्स",
      live: "थेट",
      commandCenter: "कृषी केंद्र",
    },
    nav: {
      overview: "मुख्यपृष्ठ",
      dashboard: "माझे शेत",
      digitalTwin: "माझे शेत",
    ...
    sectors: {
      fieldTelemetry: "माझे शेत आणि पिके",
      mandisEconomics: "बाजार आणि योजना",
      loyaltyRewards: "क्रेडिट्स व बक्षिसे",
      governanceAi: "इतर पर्याय",
